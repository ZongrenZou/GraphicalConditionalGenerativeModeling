...
import gcm.kernels.product as utils
...
if __name__ == "__main__":
    ...
    # 1531: the end of 1991
    # 1788: the end of 1992
    # 2038: the end of 1993
    # 2290: the end of 1994
    # 2541: the end of 1995
    # 2795: the end of 1996
    # 3047: the end of 1997
    # 3298: the end of 1998
    # 3549: the end of 1999
    # 3799: the end of 2000
    # 4049: the end of 2001
    # 4299: the end of 2002
    # 4549: the end of 2003
    # 4798: the end of 2004
    # 5049: the end of 2005
    # 5298: the end of 2006
    # 5550: the end of 2007
    # 5803: the end of 2008
    # 6055: the end of 2009
    # 6307: the end of 2010
    # 6559: the end of 2011
    # 6811: the end of 2012
    # 7063: the end of 2013
    # 7315: the end of 2014
    # 7567: the end of 2015
    # 7819: the end of 2016
    # 8069: the end of 2017
    # 8318: the end of 2018
    # 8568: the end of 2019
    # 8819: the end of 2020
    # 9070: the end of 2021
    # 9322: the end of 2022
    # 9321: the end of 2023
    # 9819: the end of 2024
    # 10067: the end of 2025
    # 10141: 2026-4-20

    # each step is a five-year window (the start and the end are inclusive)
    # step 0: 1987-1991 (250 - 1531)
    # step 1: 1992-1996 (1531 - 2795)
    # step 2: 1997-2001 (2795 - 4049)
    # step 3: 2002-2006 (4049 - 5298)
    # step 4: 2007-2011 (5298 - 6559)
    # step 5: 2012-2016 (6559 - 7819)
    # step 6: 2017-2021 (7819 - 9070)
    # step 7: 2022-2026.04/20 (9070 - 10141)
    s = 250 + 1
    e = 1531 + 1
    path_name = "samples_oil_gpr_step_0.mat"
    oil = data[s:e, 0:1]
    gpr = data[s:e, 1:2]
