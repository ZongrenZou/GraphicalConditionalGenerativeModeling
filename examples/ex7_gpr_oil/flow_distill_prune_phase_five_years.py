...
if __name__ == "__main__":
    ...
    # five-year window 1987-1991 (indices 251:1532, inclusive end in original script)
    s, e = 250 + 1, 1531 + 1
    x_data, y_data = build_oil_features(data[s:e, 0:1], data[s:e, 1:2])
    ...
    prune_oil_gpr(
        ...
        z0_samples,
        y_samples,
        fig_path="./figs/ratios_phase_five_years.png",
    )
    print("End main.")
