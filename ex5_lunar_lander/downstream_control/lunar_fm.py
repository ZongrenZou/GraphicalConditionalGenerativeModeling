...
N_EVAL_EPISODES = 50
SEED            = 42
SAVE_DIR        = "./logs/fm_impulse"

CKPT_VX = "./checkpoints/cfm_vx"
CKPT_VY = "./checkpoints/cfm_vy"
CKPT_AV = "./checkpoints/cfm_va"
...
class LunarLanderFMImpulseEnv(LunarLander):
    ...
    def _cond_vx(self, obs_norm, a1, a2):
        return np.concatenate([obs_norm, [a1, a2]]).astype(np.float64)
